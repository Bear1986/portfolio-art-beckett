            ...
            <div className=" mt-16 max-w-3xl">
              <div className="p-7 ml-[2.3rem] mr-[1.5rem]">
                ...
                <div className="p-8 text-lg drop-shadow-2xl">
                  ...
                  <br></br>
                  <p>
                    Since 2021, I've been helping clients and businesses bring
                    their digital visions to life, from custom applications to
                    landing pages and e-commerce sites.
                  </p>
                  <br></br>
                  <p>
                    My goal is to make sure that every website I work on is
                    fast, responsive, and easy to use for everyone. Whether you
                    need a new website or a hand with a project, I'm here to
                    help! Let's chat and see how we can work together.
                  </p>
                </div>
              </div>
            </div>
